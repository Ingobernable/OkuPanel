...
Description: A panel that displays live events from a Google Calendar or .ics files. By Hacklab155.
Version: 3.0
Author: Hacklab155@Ingobernable
...
define('OKUPANEL_VERSION', '3.0.3'); // increment to force assets recaching
